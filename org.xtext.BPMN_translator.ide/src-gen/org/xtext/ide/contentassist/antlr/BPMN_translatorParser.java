...
public class BPMN_translatorParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, BPMN_translatorGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getProtocol_dataAccess().getAlternatives_1(), "rule__Protocol_data__Alternatives_1");
			...
			builder.put(grammarAccess.getProtocolAccess().getGroup_2(), "rule__Protocol__Group_2__0");
			builder.put(grammarAccess.getProtocol_dataAccess().getGroup(), "rule__Protocol_data__Group__0");
			builder.put(grammarAccess.getProtocol_dataAccess().getGroup_1_0(), "rule__Protocol_data__Group_1_0__0");
			builder.put(grammarAccess.getProtocol_dataAccess().getGroup_1_1(), "rule__Protocol_data__Group_1_1__0");
			builder.put(grammarAccess.getProtocol_dataAccess().getGroup_1_2(), "rule__Protocol_data__Group_1_2__0");
			builder.put(grammarAccess.getProtocol_dataAccess().getGroup_1_3(), "rule__Protocol_data__Group_1_3__0");
			...
			builder.put(grammarAccess.getProtocolAccess().getProtocol_dataAssignment_2_0(), "rule__Protocol__Protocol_dataAssignment_2_0");
			builder.put(grammarAccess.getProtocolAccess().getProtocol_deviceAssignment_2_1(), "rule__Protocol__Protocol_deviceAssignment_2_1");
			builder.put(grammarAccess.getProtocol_dataAccess().getPnameAssignment_1_0_2(), "rule__Protocol_data__PnameAssignment_1_0_2");
			builder.put(grammarAccess.getProtocol_dataAccess().getMacAssignment_1_1_2(), "rule__Protocol_data__MacAssignment_1_1_2");
			builder.put(grammarAccess.getProtocol_dataAccess().getIp_addressAssignment_1_2_2(), "rule__Protocol_data__Ip_addressAssignment_1_2_2");
			builder.put(grammarAccess.getProtocol_dataAccess().getServer_addressAssignment_1_3_2(), "rule__Protocol_data__Server_addressAssignment_1_3_2");
			builder.put(grammarAccess.getProtocol_deviceAccess().getProtocol_deviceAssignment_2(), "rule__Protocol_device__Protocol_deviceAssignment_2");
			builder.put(grammarAccess.getSensorAccess().getSensorAssignment_2(), "rule__Sensor__SensorAssignment_2");
			builder.put(grammarAccess.getSensor_dataAccess().getPnameAssignment_1_0_2(), "rule__Sensor_data__PnameAssignment_1_0_2");
			builder.put(grammarAccess.getSensor_dataAccess().getTypeAssignment_1_1_2(), "rule__Sensor_data__TypeAssignment_1_1_2");
			builder.put(grammarAccess.getSensor_dataAccess().getPinsAssignment_1_2_2(), "rule__Sensor_data__PinsAssignment_1_2_2");
		}
	}
