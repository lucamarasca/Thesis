 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.bPMN_translator.impl.protocol_deviceImpl#getDname <em>Dname</em>}</li>
 * </ul>
 *
 * @generated
 */
public class protocol_deviceImpl extends MinimalEObjectImpl.Container implements protocol_device
{
  ...
  public EList<String> getDname()
  {
    if (dname == null)
    {
      dname = new EDataTypeEList<String>(String.class, this, BPMN_translatorPackage.PROTOCOL_DEVICE__DNAME);
    }
    return dname;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case BPMN_translatorPackage.PROTOCOL_DEVICE__DNAME:
        return getDname();
    }
